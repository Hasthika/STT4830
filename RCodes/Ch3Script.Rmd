...
library(ggplot2)
library(dplyr)
plasmaData <- read.table("http://users.stat.ufl.edu/~rrandles/sta4210/Rclassnotes/data/textdatasets/KutnerData/Chapter%20%203%20Data%20Sets/CH03TA08.txt", sep ="" , header = FALSE)
...
# Find the transformed X values
    plasmaDataTrans <- plasmaData %>%
      mutate(plasmaLevelLog  = log10(plasmaLevel))
...
# Perform a correlation test for normality for this data
  ...
  # Notice the correlation between residuals and expected residulas is ______.
  # The critical value when alpha = 0.01, is _____. 
